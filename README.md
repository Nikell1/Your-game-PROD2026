...
В проекте используются стили и цвета из globals.css, а также для динамического определения цвета из colors-constants.ts

# Функционал

Реализованы все основные функции приложения. В игре есть предустановленный пакет тем(20) и вопросов по этим темам(600).
...
На этапе создания игры можно настроить количество игроков (от 2 до 8). Всё функции корректно работают для максимального числа игроков.
